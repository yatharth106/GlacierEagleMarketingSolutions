    ...
    <div className="min-h-screen bg-ivory-warm text-charcoal-deep font-paragraph selection:bg-stone-soft selection:text-ivory-warm overflow-x-clip">
      ...
      <section className="w-full relative min-h-[85vh] flex flex-col justify-center items-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-30 pointer-events-none">
           <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-stone/20 rounded-full blur-[100px] mix-blend-multiply animate-pulse" style={{ animationDuration: '10s' }} />
           <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-stone/30 rounded-full blur-[120px] mix-blend-multiply" />
        </div>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-wrap justify-center md:justify-between items-center gap-x-12 gap-y-6 opacity-70">
              {industries.length > 0 ? (
                ...
                // Fallback if no data
                <>
                  <span className="text-sm font-medium uppercase tracking-widest">B2B SaaS</span>
                  <span className="text-sm font-medium uppercase tracking-widest">Professional Services</span>
                  <span className="text-sm font-medium uppercase tracking-widest">High-Ticket Consultancies</span>
                  <span className="text-sm font-medium uppercase tracking-widest">Mid-Market Technology</span>
                </>
              )}
            </div>
          )}
                ...
                problems.filter(p => p.isCommon).map((problem, index) => (
                  ...
                  >
                    ...
                    {problem.revenueImpact && (
                      <div className="mt-4 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-destructive/70">
      ...
      <section className="w-full py-32 bg-ivory">
        <div className="max-w-[100rem] mx-auto px-6 md:px-12">
          <FadeIn className="mb-24 text-center">
            <h2 className="text-5xl font-heading text-charcoal">Our Advisory Process</h2>
          </FadeIn>

          <div className="relative max-w-4xl mx-auto">
            {/* Vertical Line */}
            <div className="absolute left-[15px] md:left-1/2 top-0 bottom-0 w-px bg-stone md:-translate-x-1/2" />
            ...
            {[
              ...
              >
                ...
                <div className={`md:w-1/2 pl-12 md:pl-0 ${i % 2 === 0 ? 'md:pl-16 text-left' : 'md:pr-16 md:text-right'}`}>
                  <span className="text-sm font-bold text-muted-gold-accent tracking-widest uppercase mb-2 block">Step {item.step}</span>
                  <h3 className="text-2xl font-heading text-charcoal mb-3">{item.title}</h3>
                  <p className="text-charcoal/60">{item.desc}</p>
                </div>

                {/* Center Node */}
                <div className="absolute left-0 md:left-1/2 w-8 h-8 bg-ivory border-2 border-charcoal rounded-full flex items-center justify-center z-10 md:-translate-x-1/2">
      ...
      <section className="w-full py-24 bg-charcoal text-ivory">
        <div className="max-w-[120rem] mx-auto px-6 md:px-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-ivory/10">
            {[
              ...
              <motion.div
                ...
                className="p-4"
              >
                <div className="text-4xl md:text-5xl font-heading font-bold text-ivory mb-2">{stat.val}</div>
                <div className="text-sm text-ivory/60 uppercase tracking-widest">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="w-full py-32 bg-ivory">
        <div className="max-w-2xl mx-auto px-6 md:px-12 text-center">
          <FadeIn>
            <div className="w-16 h-1 bg-charcoal mx-auto mb-12" />
            <h2 className="text-3xl font-heading text-charcoal mb-8">A Note From the Founder</h2>
            <div className="space-y-6 text-lg text-charcoal/80 leading-relaxed font-serif italic">
              <p>
            ...
            <div className="mt-12">
              <p className="font-heading font-bold text-charcoal">The Glacier Eagle Team</p>
            </div>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="w-full py-32 bg-stone/20 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 md:px-12 relative z-10">
          <div className="bg-ivory p-8 md:p-16 shadow-2xl shadow-stone/20 border border-stone/40">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-heading text-charcoal mb-4">Request a Private Revenue Audit</h2>
              <p className="text-charcoal/60">Limited engagements accepted quarterly.</p>
            </div>

            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-charcoal/70">Company Name</label>
                  <input type="text" className="w-full bg-transparent border-b border-stone py-2 focus:border-charcoal outline-none transition-colors" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-charcoal/70">ARR Range</label>
                  <select className="w-full bg-transparent border-b border-stone py-2 focus:border-charcoal outline-none transition-colors">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-charcoal/70">Primary Revenue Challenge</label>
                <input type="text" className="w-full bg-transparent border-b border-stone py-2 focus:border-charcoal outline-none transition-colors" />
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-charcoal/70">Current Email Platform</label>
                  <input type="text" className="w-full bg-transparent border-b border-stone py-2 focus:border-charcoal outline-none transition-colors" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-charcoal/70">CRM Used</label>
                  <input type="text" className="w-full bg-transparent border-b border-stone py-2 focus:border-charcoal outline-none transition-colors" />
                </div>
              </div>
              ...
              <div className="pt-8 text-center">
                <Link to="/application">
                  <Button className="w-full md:w-auto bg-charcoal text-ivory hover:bg-charcoal/90 rounded-none px-12 py-6 text-lg font-medium tracking-wide">
                    Submit for Review
                  </Button>
                </Link>
              </div>
      ...
      {/* --- 14. FAQ Section --- */}
      <section className="w-full py-24 bg-ivory">
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          <h2 className="text-3xl font-heading text-charcoal mb-12 text-center">Common Questions</h2>
          <div className="space-y-8">
            {[
              ...
              <div key={i} className="border-b border-stone pb-8">
                <h3 className="text-lg font-bold text-charcoal mb-2">{faq.q}</h3>
                <p className="text-charcoal/60">{faq.a}</p>
              </div>
            ))}
          </div>
        </div>
