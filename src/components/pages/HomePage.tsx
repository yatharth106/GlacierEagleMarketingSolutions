...
export default function HomePage() {
  ...
  return (
    <PageLayout>
      ...
      {/* --- 2. PRICING & ALIGNMENT MODEL SECTION --- */}
      <section className="w-full py-section bg-slate-deep">
        <div className="max-w-content mx-auto px-6 md:px-12">
          {/* Section Header */}
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            ...
            {/* Headline */}
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-semibold text-ivory-primary mb-8 leading-tight">
              Compensation Aligned With Revenue Impact.
            </h2>
            
            {/* Subline */}
            <p className="text-lg font-paragraph text-ivory-body max-w-[760px] mx-auto leading-relaxed mb-10">
              We structure engagements so our success is directly tied to your revenue growth. No billable hours. No vanity metrics. Pure alignment.
            </p>
          ...
          {/* Three-Panel Pricing Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {/* Panel 1: Base Strategic Fee */}
            <StaggerItem>
              <motion.div
                whileHover={{ 
                  borderColor: 'rgba(168, 132, 59, 0.6)',
                  boxShadow: '0 12px 30px rgba(0, 0, 0, 0.25)',
                  y: -4
                }}
                transition={{ duration: 0.3, ease: "easeOut" }}
                className="bg-card-bg p-8 md:p-12 border border-divider rounded-[6px] h-full flex flex-col justify-between"
              >
                {/* Label */}
                <p className="text-[10px] uppercase tracking-[2px] text-gold-antique font-label font-bold mb-6">
                  Component 1
                </p>
                
                {/* Title */}
                <h3 className="text-2xl md:text-3xl font-heading text-ivory-primary mb-6 leading-tight">
                  Base Strategic Fee
                </h3>
                
                {/* Description */}
                <p className="text-base font-paragraph text-ivory-body leading-relaxed mb-8">
                  Monthly retainer covering strategy, system architecture, and ongoing optimization.
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-xs text-gold-antique/60 uppercase tracking-wider font-label font-bold mb-2">
                      Includes
                    </p>
                    <ul className="space-y-3">
                      {[
                        ...
                        <li key={idx} className="flex items-start gap-2 text-sm text-ivory-body">
                          <div className="w-1.5 h-1.5 bg-gold-antique rounded-full mt-1.5 shrink-0" />
                          {item}
                        </li>
                      ))}
                    </ul>
            ...
            {/* Panel 2: Performance Revenue Share */}
            <StaggerItem>
              <motion.div
                whileHover={{ 
                  borderColor: 'rgba(168, 132, 59, 0.6)',
                ...
                transition={{ duration: 0.3, ease: "easeOut" }}
                className="bg-card-bg p-8 md:p-12 border border-gold-antique/40 rounded-[6px] h-full flex flex-col justify-between ring-1 ring-gold-antique/20"
              >
                {/* Label */}
                <p className="text-[10px] uppercase tracking-[2px] text-gold-antique font-label font-bold mb-6">
                  Component 2 (Primary Alignment)
                </p>
                ...
                {/* Description */}
                <p className="text-base font-paragraph text-ivory-body leading-relaxed mb-8">
                  We participate in incremental revenue generated from the systems we build.
                </p>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-ivory-body leading-relaxed">
                      Revenue share applies only to <span className="text-ivory-primary font-semibold">incremental revenue</span> directly attributable to our systems — measured against your baseline.
                    </p>
                  </div>

                  {/* Example */}
                  <div className="bg-navy-dark/50 p-4 rounded-[4px] border border-gold-antique/20">
                    <p className="text-xs text-gold-antique/70 uppercase tracking-wider font-label font-bold mb-2">
                      Example
                    </p>
                    <p className="text-sm text-ivory-body leading-relaxed">
                      If your baseline is $50K/month and we drive it to $65K/month, the $15K incremental is subject to our share.
                    </p>
                  </div>

                  {/* Revenue Share Tiers */}
                  <div>
                    <p className="text-xs text-gold-antique/60 uppercase tracking-wider font-label font-bold mb-3">
                      Revenue Share by Tier
                    </p>
                    <div className="space-y-2">
                      {[
                        { tier: 'Tier I (Trust)', share: '15%' },
                        { tier: 'Tier II (Patrimony)', share: '20%' },
                        { tier: 'Tier III (Estate)', share: '25%' }
                      ].map((item, idx) => (
                        <div key={idx} className="flex justify-between items-center text-sm">
                          <span className="text-ivory-body">{item.tier}</span>
                          <span className="text-gold-antique font-semibold">{item.share}</span>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            {/* Panel 3: Optional Equity Alignment */}
            <StaggerItem>
              <motion.div
                whileHover={{ 
                  borderColor: 'rgba(168, 132, 59, 0.6)',
              ...
              >
                ...
                {/* Description */}
                <p className="text-base font-paragraph text-ivory-body leading-relaxed mb-8">
                  For select engagements, we take equity to reflect long-term conviction in the business.
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="space-y-3">
                      {[
                        'High-growth trajectory companies',
                        'Clear path to exit or scale',
                        'Founder-led businesses',
                        'Strategic market fit alignment',
          ...
          >
            <p className="text-lg font-paragraph text-ivory-body leading-relaxed max-w-3xl mx-auto">
              This structure ensures we are perpetually motivated to build systems that compound in your favor. We win when you win. We scale when you scale.
            </p>
          </motion.div>
        </div>
      </section>
